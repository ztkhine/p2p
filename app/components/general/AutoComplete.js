...
import { zipLookup } from '../../lib/ApiClient';
...
class AutoComplete extends React.Component {
  ...
  _adjustFrame = (style) => {
    ...
    Object.assign(style, { width: width - totalSidePadding, height: contentHeight, top: style.top })
    return style
  }
  ...
  _onChange = (text) => {
    ...
    if (text.length === 0 || !text) {
      ...
      zipLookup({ post_code: text }, (json) => {
        if (json.success) {
          this.setState({ optionsList: json.data })
